    ...
    <div class="row">
      <div class="col p-3">
        <form>
         ...
         <div class="form-group row">
           <div class="col-sm-2">
             ...
             <label for="branch">Job Type:</label>
           </div>
           <div class="col-sm-10">
            ...
            <div class="dropdown mb-2">
              ...
              <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item"  name="fulltime" id="fulltime" data-value="Full Time Jobs">Full Time job</a>
                <a class="dropdown-item"  name="parttime" id="parttime" data-value="Part Time Jobs">Part time job</a>
                <a class="dropdown-item"  name="workfromhome" id="workfromhome" data-value="Work From Home">Work From Home</a>
                <a class="dropdown-item"  name="internships" id="internships" data-value="Internships">Internships</a>
              </div>
            </div>
          </div>
           </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="numeric" name="salary" id="salary" class="form-control" placeholder="Salary" > 
          </div>
